...
function Home() {
  return (
    <div className="bg-[#eef4f5] max-w-[1400px] my-0 mx-auto p-[2rem] rounded-xl flex justify-between flex-col lg:flex-row">
      <div className="max-w-full md:max-w-[500px]">
        <div className="right-side  mb-4 flex flex-col justify-center items-center md:justify-start md:items-start">
          <p className="text-2xl  font-bold text-black my-5 leading-snug md:text-6xl">
      ...
      <div className="left-side flex gap-5 flex-col justify-center items-center lg:flex-row lg:justify-start lg:items-start">
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="">
            <div className="bg-[var(--theme-text-color)] flex flex-col gap-7 justify-center items-center font-bold text-white p-5 rounded-xl">
              ...
              <Link href="/shop">
                <Button className="bg-[#274c4f] rounded-xl">Explore Now</Button>
              </Link>
            </div>
          </div>
        </div>
